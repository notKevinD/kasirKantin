  ...
  return (
    ...
    >
      ...
      >
        ...
        {activeTab === "kasir" && (
          <div className="grid flex-1 gap-3 lg:min-h-[760px] lg:grid-cols-[210px_minmax(0,1fr)_330px] lg:overflow-hidden xl:min-h-[820px] xl:gap-4 xl:grid-cols-[280px_minmax(0,1fr)_420px]">
